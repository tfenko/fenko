...
const TRACKS_DATA = {
  ...
  stillgetclose: {
    ...
    lyrics: [
      ...
      { time: 34.60, text: "But you looking through" },
      { time: 39.10, text: "You say my name and bite your lip" },
      { time: 43.50, text: "One more drink, one more stupid trip" },
      { time: 47.95, text: "I know exactly where this goes" },
      { time: 52.30, text: "But I still get close" },
      { time: 56.80, text: "You got me (you got me)" },
      { time: 61.15, text: "Right where you want me (no warning)" },
      { time: 63.40, text: "No warning" },
      { time: 65.60, text: "No way to stop it" },
      { time: 67.85, text: "You make me lose my mind (lose my mind)" },
      { time: 72.25, text: "Every single time" },
      { time: 76.65, text: "I tell myself goodbye (goodbye)" },
      { time: 81.05, text: "Then I stay all night" },
      { time: 85.50, text: "I know you trouble, I know the signs" },
      { time: 89.90, text: "But you make me lose my mind" },
      { time: 94.30, text: "Every single time" },
      { time: 120.40, text: "City lights reflected in your eyes (in your eyes)" },
      { time: 124.80, text: "We're too good at telling pretty lies" },
      { time: 129.20, text: "Nothing here is built to last" },
      { time: 133.55, text: "But we're moving fast" },
      { time: 138.05, text: "Handshake when you pull me in" },
      { time: 142.45, text: "Maybe that's why I never win (never win)" },
      { time: 146.85, text: "Every time I try to leave" },
      { time: 151.20, text: "You get what you need" },
      { time: 155.70, text: "You got me" },
      { time: 160.05, text: "Right where you want me" },
      { time: 164.50, text: "You know it, I know it" },
      { time: 168.90, text: "Nobody's innocent" },
      { time: 171.10, text: "You make me lose my mind (lose my mind)" },
      { time: 175.50, text: "Every single time" },
      { time: 179.90, text: "I tell myself goodbye (goodbye)" },
      { time: 184.30, text: "Then I stay all night" },
      { time: 188.75, text: "I know you trouble, I know the signs" },
      { time: 193.15, text: "But you make me lose my mind" },
      { time: 197.55, text: "Every single time" },
      { time: 215.20, text: "Every single time" },
      { time: 219.60, text: "Every single time" },
      { time: 224.00, text: "Every single time" }
    ]
  }
};
