...
const iconSizes: { [key: string]: string } = {
  ...
  Spotify: 'w-6 h-6',
  YouTube: 'w-6.5 h-6.5 scale-[1]', // Акуратний мікро-масштаб для ідеального балансу
  SoundCloud: 'w-6 h-6',
};
...
const releases = [
  {
    ...
    links: [
      ...
      { name: 'Spotify', url: 'https://open.spotify.com/track/6QVCaTgY_r7w' },
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Spotify', url: 'https://open.spotify.com/track/5Fs0ZWHbaxBg' },
