                    ...
                    <div className="w-full max-w-sm">
                      ...
                      <div className="flex flex-wrap gap-2 font-mono text-[9px] uppercase tracking-widest">
                        <button 
                          ...
                          disabled={track.id === 5}
                          className={`px-3 py-1.5 rounded-md border transition-all ${track.id === 5 ? 'opacity-30 cursor-not-allowed border-foreground/10 text-foreground/30' : currentPlatform === 'spotify' ? 'border-foreground bg-foreground text-background' : 'border-foreground/10 text-foreground/50 hover:text-foreground'}`}
                        >
                          Spotify
                        </button>
                        <button 
                          ...
                          disabled={track.id === 5}
                          className={`px-3 py-1.5 rounded-md border transition-all ${track.id === 5 ? 'opacity-30 cursor-not-allowed border-foreground/10 text-foreground/30' : currentPlatform === 'apple' ? 'border-foreground bg-foreground text-background' : 'border-foreground/10 text-foreground/50 hover:text-foreground'}`}
                        >
                          Apple Music
                        </button>
                        <button 
                          ...
                          disabled={track.id === 5}
                          className={`px-3 py-1.5 rounded-md border transition-all ${track.id === 5 ? 'opacity-30 cursor-not-allowed border-foreground/10 text-foreground/30' : currentPlatform === 'soundcloud' ? 'border-foreground bg-foreground text-background' : 'border-foreground/10 text-foreground/50 hover:text-foreground'}`}
                        >
                          SoundCloud
                        </button>
                        <button 
                          ...
                          disabled={track.id === 5}
                          className={`px-3 py-1.5 rounded-md border transition-all ${track.id === 5 ? 'opacity-30 cursor-not-allowed border-foreground/10 text-foreground/30' : currentPlatform === 'youtube' ? 'border-foreground bg-foreground text-background' : 'border-foreground/10 text-foreground/50 hover:text-foreground'}`}
                        >
                          YouTube
                        </button>
                      </div>
