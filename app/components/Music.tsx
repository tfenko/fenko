...
// Ідеально збалансовані, вирівняні контурні іконки (Line Icons)
const platformIcons: { [key: string]: React.ReactNode } = {
  Spotify: (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10" />
      <path d="M8 11.5c2.5-1 5.5-.5 7.5 1" />
      <path d="M7 9c3.5-1.5 7.5-1 10 1" />
      <path d="M9 14c2-1 4-1 5.5 0" />
    </svg>
  ),
  'Apple Music': (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  SoundCloud: (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 20h9a3 3 0 0 0 1-5.8 5 5 0 0 0-8.3-4.3A4 4 0 0 0 6 12a4.1 4.1 0 0 0 .1 1" />
      <path d="M6 20v-4" />
      <path d="M2 18v-1" />
    </svg>
  )
                ...
                <div className="w-full flex flex-wrap justify-center lg:justify-start gap-x-8 md:gap-x-6 gap-y-4 pt-6 border-t border-[#141414]">
                  {track.links.map((link) => (
                    ...
                    >
                      ...
                      {/* Лінія підкреслення на десктопі */}
